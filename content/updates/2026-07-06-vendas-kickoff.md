...
Valores em dias e períodos aleatórios foram conferidos e foi visto que no relatório mais usado do sistema (Documentos Emitidos) os valores dos produtos são: Preço do Produto + Impostos + Frete + Acréscimos - Descontos. Mantive assim no Dashboard.
